...
/*********************************************************
* 编    号: No054
* 函 数 名: HBI_SetgGainMode
* 功能描述: 设置增益模式
* 参数说明:
		In: void *handle - 句柄(无符号指针)
			int mode - 模式,[1]-4.8pC [2]-7.2pC [3]-9.6pC
			           默认7.2pC
		Out: 无
* 返 回 值：int
			0   - 成功
...
* 备    注:
*********************************************************/
HB_PDF_DLL int __stdcall HBI_SetgGainMode(void *handle, int nGainMode);

/*********************************************************
* 编    号: No055
* 函 数 名: HBI_GetgGainMode
* 功能描述: 获取增益模式
* 参数说明:
		In: void *handle - 句柄(无符号指针)
		Out: 无
...
* 备    注:
*********************************************************/
HB_PDF_DLL int __stdcall HBI_GetgGainMode(void *handle);
#ifdef _cplusplus
}
#endif
